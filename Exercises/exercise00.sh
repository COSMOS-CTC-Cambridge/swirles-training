...
#SBATCH --partition spr        #name of partition either pvc, ampere, genoa, spr 
#SBATCH --nodes=1          #how many nodes
#SBATCH --ntasks=4         #how many tasks (usu MPI ranks) in total 
...
#load relevent modules here


srun -prepend-rank hostname
